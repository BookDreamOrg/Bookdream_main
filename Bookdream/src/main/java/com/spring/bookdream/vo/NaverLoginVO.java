...
import com.spring.bookdream.auth.NaverAPI20;
...
public class NaverLoginVO {
    ...
    private final static String CLIENT_ID = "0328Vi7efumpXAgBjKZA"; // 클라이언트 아이디
    private final static String CLIENT_SECRET = "W2upi_g63s"; // 클라이언트 시크릿
    private final static String REDIRECT_URI = "http://localhost:8000/auth/naver/callback";
    ...
    public String getAuthorizationUrl(HttpSession session) {
        ...
        OAuth20Service oauthService = new ServiceBuilder(null)                                                   
                .apiKey(CLIENT_ID)
